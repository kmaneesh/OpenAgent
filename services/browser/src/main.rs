...
async fn main() -> anyhow::Result<()> {
    ...
    server.register_tool(
        "browser.open",
        handler!("browser.open", handle_open, sessions, tel),
    );
    server.register_tool(
        "browser.navigate",
        handler!("browser.navigate", handle_navigate, sessions, tel),
    );
    server.register_tool(
        "browser.close",
    ...
    server.register_tool(
        "browser.snapshot",
        handler!("browser.snapshot", handle_snapshot, sessions, tel),
    );
    server.register_tool(
        "browser.screenshot",
        handler!("browser.screenshot", handle_screenshot, sessions, tel),
    );
    server.register_tool(
        "browser.get",
        handler!("browser.get", handle_get, sessions, tel),
    );
    server.register_tool(
        "browser.wait",
        handler!("browser.wait", handle_wait, sessions, tel),
    );
    server.register_tool(
        "browser.eval",
        handler!("browser.eval", handle_eval, sessions, tel),
    );
    server.register_tool(
        "browser.extract",
        handler!("browser.extract", handle_extract, sessions, tel),
    );
    server.register_tool(
        "browser.is",
        handler!("browser.is", handle_is, sessions, tel),
    );
    server.register_tool(
        "browser.console",
        handler!("browser.console", handle_console, sessions, tel),
    );
    server.register_tool(
        "browser.errors",
        handler!("browser.errors", handle_errors, sessions, tel),
    );
    server.register_tool(
        "browser.diff",
        handler!("browser.diff", handle_diff, sessions, tel),
    );
    server.register_tool(
        "browser.highlight",
        handler!("browser.highlight", handle_highlight, sessions, tel),
    );
    // ── User interaction ─────────────────────────────────────────────────────
    server.register_tool(
        "browser.click",
        handler!("browser.click", handle_click, sessions, tel),
    );
    server.register_tool(
        "browser.dblclick",
        handler!("browser.dblclick", handle_dblclick, sessions, tel),
    );
    server.register_tool(
        "browser.fill",
        handler!("browser.fill", handle_fill, sessions, tel),
    );
    server.register_tool(
        "browser.type",
        handler!("browser.type", handle_type, sessions, tel),
    );
    server.register_tool(
        "browser.press",
        handler!("browser.press", handle_press, sessions, tel),
    );
    server.register_tool(
        "browser.hover",
        handler!("browser.hover", handle_hover, sessions, tel),
    );
    server.register_tool(
        "browser.select",
        handler!("browser.select", handle_select, sessions, tel),
    );
    server.register_tool(
        "browser.check",
        handler!("browser.check", handle_check, sessions, tel),
    );
    server.register_tool(
        "browser.scroll",
        handler!("browser.scroll", handle_scroll, sessions, tel),
    );
    server.register_tool(
        "browser.scrollinto",
        handler!("browser.scrollinto", handle_scrollinto, sessions, tel),
    );
    server.register_tool(
        "browser.find",
        handler!("browser.find", handle_find, sessions, tel),
    );
    server.register_tool(
        "browser.focus",
        handler!("browser.focus", handle_focus, sessions, tel),
    );
    server.register_tool(
        "browser.drag",
        handler!("browser.drag", handle_drag, sessions, tel),
    );
    server.register_tool(
        "browser.upload",
        handler!("browser.upload", handle_upload, sessions, tel),
    );
    server.register_tool(
        "browser.keydown",
        handler!("browser.keydown", handle_keydown, sessions, tel),
    );
    server.register_tool(
        "browser.keyup",
        handler!("browser.keyup", handle_keyup, sessions, tel),
    );
    // ── Navigation history ───────────────────────────────────────────────────
    server.register_tool(
        "browser.back",
        handler!("browser.back", handle_back, sessions, tel),
    );
    server.register_tool(
        "browser.forward",
        handler!("browser.forward", handle_forward, sessions, tel),
    );
    server.register_tool(
        "browser.reload",
        handler!("browser.reload", handle_reload, sessions, tel),
    );
    // ── Tabs ─────────────────────────────────────────────────────────────────
    server.register_tool(
        "browser.tab_new",
        handler!("browser.tab_new", handle_tab_new, sessions, tel),
    );
    server.register_tool(
        "browser.tab_switch",
        handler!("browser.tab_switch", handle_tab_switch, sessions, tel),
    );
    server.register_tool(
        "browser.tab_list",
        handler!("browser.tab_list", handle_tab_list, sessions, tel),
    );
    server.register_tool(
        "browser.tab_close",
        handler!("browser.tab_close", handle_tab_close, sessions, tel),
    );
    // ── Frames & dialogs ─────────────────────────────────────────────────────
    server.register_tool(
        "browser.frame",
        handler!("browser.frame", handle_frame, sessions, tel),
    );
    server.register_tool(
        "browser.dialog",
        handler!("browser.dialog", handle_dialog, sessions, tel),
    );
    // ── Storage & state ──────────────────────────────────────────────────────
    server.register_tool(
        "browser.cookies",
        handler!("browser.cookies", handle_cookies, sessions, tel),
    );
    server.register_tool(
        "browser.state",
        handler!("browser.state", handle_state, sessions, tel),
    );
    server.register_tool(
        "browser.storage",
        handler!("browser.storage", handle_storage, sessions, tel),
    );
    server.register_tool(
        "browser.pdf",
        handler!("browser.pdf", handle_pdf, sessions, tel),
    );
    // ── Browser configuration ────────────────────────────────────────────────
    server.register_tool(
        "browser.set",
        handler!("browser.set", handle_set, sessions, tel),
    );
    server.register_tool(
        "browser.network",
        handler!("browser.network", handle_network, sessions, tel),
    );
    server.register_tool(
        "browser.mouse",
        handler!("browser.mouse", handle_mouse, sessions, tel),
    );
